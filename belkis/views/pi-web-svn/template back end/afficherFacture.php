                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div >
                            <div >
                                <!-- DATA TABLE -->
                               <h3 class="title-5 m-b-35" style="position: absolute;width: 300px;left: -15%">tableaux de factures</h3>
                               ...
                               <!--  <div class="table-data__tool">
                                ...
                                <div class="table-responsive table-responsive-data2" style="position: absolute;width: 100px;left: -14%;top: 30px">
