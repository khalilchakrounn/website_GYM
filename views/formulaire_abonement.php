                    ...
                    <div class="container-fluid">
                         <div class="card">
                                        ...
                                        <form id="formulaire_a" method="POST" enctype="multipart/form-data" class="form-horizontal" action="ajout_abonement.php">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="abonement_input" name="abonement_input" placeholder="nom abonementt" class="form-control" required>
                                                </div>
                                            </div>                                          
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary btn-sm" onclick="submit_a()">
