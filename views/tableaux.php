                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active">
                            <a href="Produits.html">
                                <i class="fas fa-table"></i>Produits</a>
                        </li>
                        <li>
                            <a href="form.html">
                                <i class="far fa-check-square"></i>Forms</a>
...
<!-- tableau de produits -->                       
                                            ...
                                            <td><?PHP echo $row['id']; ?></td>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="supp_produit.php?delete=<?php echo $row['id'];?>"><button class="item" data-toggle="tooltip" data-placement="top" title="Supprimer">
 ...
 <!-- fin tableau categorie -->
</br></br></br></br>
 <!-- tableau des abonement -->                       
                        <div >
                            <div >
