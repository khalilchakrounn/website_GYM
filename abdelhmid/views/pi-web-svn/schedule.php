  	...
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    ...
	    <a  href="index.html"><img src="images\logo.png"> </a>
         ...
         <li style="list-style-type:none;" class="main-nav-list"><a href="panier.html" class="nav-link"><img  src="images\icons\panier1.png" style="width:40px"></li>
            <li style="list-style-type:none;" class="main-nav-list"> <a data-toggle="collapse" href="#Cat2"  > <img style="position: absolute; top: 47px; right: 5.75%" id="myImage" src="images\acc.png" style="width:30px"></a>
						    ...
						    <tbody>
						      <tr class="text-center">
						        <td class="color">
						         ...
						         <td class="color-1">
						        	 <h3><a href="#"><?php echo $row1['cour'];?></a></h3>
						        	<span class="at"><?php echo $row1['descrip'];?></span>
						        	<p class="time"><?php echo $row1['temps'];?></p>
						        	<span class="trainer"><?php echo $row1['cour'];?></span>
						        </td>
